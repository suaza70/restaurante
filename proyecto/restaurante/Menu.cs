public class Menu
{
    ...
    public Menu()
    {
        ...
        bebidas.Agregar(new Plato(6, "jugo de mora", "jugo natural de mora en agua o leche", 6000));
        bebidas.Agregar(new Plato(7, "limonada natural", "limonada fresca con hielo y azucar", 5000));
        bebidas.Agregar(new Plato(8, "gaseosa", "bebida carbonatada en botella de 400ml", 4000));
        bebidas.Agregar(new Plato(9, "Agua en botella", "agua mineral sin gas", 3000));
        bebidas.Agregar(new Plato(10, "Cerveza", "cerveza nacional fria", 7000));

        postres = new ListaEnlazada<Plato>();
        postres.Agregar(new Plato(11, "flan de caramelo", "flan casero con salsa de caramelo", 7000));
        postres.Agregar(new Plato(12, "arroz con leche", "arroz con leche y canela al gusto", 6000));
        postres.Agregar(new Plato(13, "tiramisu", "postre italiano con cafe y queso mascarpone", 8500));
        postres.Agregar(new Plato(14, "helado", "helado de vainilla, chocolate o fresa", 5000));
        postres.Agregar(new Plato(15, "brownie con helado", "brownie de chocolate caliente con bola de helado", 9000));
    }
